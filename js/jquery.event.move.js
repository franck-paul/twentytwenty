...
((fn) => {
  ...
  (() => {
    ...
    function CustomEvent(event, user_params) {
      const params = user_params || { bubbles: false, cancelable: false, detail: undefined };
  ...
  function on(node, user_types, fn, data, _selector) {
    const types = user_types.split(rspaces);
  ...
  function off(node, user_types, fn, _selector) {
    const types = user_types.split(rspaces);
  ...
  function activeMouseend(_e, data) {
